...
// Team Name" Racing Bulls
// Members: Blake Cantave ID: bcantave1, Iyana Halliburton ID: ihalliburton1
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      const Text("TOTAL ORDERS", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
                  ...
                  Column(
                    children: [
                      const Text("MONEY TOTAL", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.grey)),
                      const SizedBox(height: 4),
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("ORDER BURGER"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("ORDER PIZZA"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("ORDER DRINK"),
                ),
                TactileButton(
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("ORDER CHICKEN"),
                ),
              ],
            ),
