...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final screenBg = widget.isDark
        ? (powerLevel > 80 ? const Color(0xFF3A1712) : const Color(0xFF1E1F29))
        : (powerLevel > 80 ? const Color(0xFFFBE6DF) : const Color(0xFFE0E5EC));
            ...
            Wrap(
              ...
              children: [
                TactileButton(
                  ...
                  onPressed: () => _triggerAction("JUMP BOOST"),
                ),
                TactileButton(
                  icon: Icons.bolt,
                  label: "FIRE",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("FIRE BLASTER"),
                ),
                TactileButton(
                  icon: Icons.speed,
                  label: "SPEED",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("SPEED BOOST"),
                ),
                TactileButton(
                  icon: Icons.pause,
                  label: "PAUSE",
                  ...
                  isDark: widget.isDark,
                  onPressed: () => _triggerAction("PAUSE SYSTEM"),
                ),
              ],
            ),
